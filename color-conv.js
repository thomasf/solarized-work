...
(function() {
  var ac, base, c, colorList, colorTransform, colors, dispatcher, hex, hexToColor, i, j, listName, n, name, parameters, render, transform, vc_colors, vc_colors_string;
  ...
  vc_colors = _.union(ac.red, ac.red.range(ac.yellow, 4), ac.yellow, ac.yellow.range(ac.green, 6), ac.green, ac.green.range(ac.cyan, 6), ac.cyan, ac.cyan.range(ac.blue, 5), ac.blue);
  ...
  render = function() {
    var bd, box, box2, ccol, color, dark, elisp, hd, light, normal, _i, _len, _ref, _ref1;
